...
const groups=[
 ['gambler','gambler','도박사',['도박사 기본 스킨','부르주아','가면 무도회']],
 ['berserker','berserker','광전사',['광전사 기본 스킨','혹한의 야만족','지옥불 광전사']],
 ['imp','imp','임프',['임프 기본 스킨','트릭 오어 트릿!','지옥불 요정']],
 ['mage','mage','마법사',['마법사 기본 스킨','눈꽃 마녀','신의 사도']],
 ['prophet','seer','예언가',['예언가 기본 스킨','붉은 달의 예언가','점성술사']],
 ['thief','rogue','도적',['도적 기본 스킨','신출귀몰의 괴도','무도회의 불청객']],
 ['travler','adventurer','모험가',['모험가 기본 스킨','설산의 탐험가','신참 항해사']],
 ['warrior','warrior','전사',['전사','성지 수호자','북부의 병사']],
];
export const SKINS=Object.fromEntries(groups.flatMap(([stem,character,label,names])=>names.map((name,index)=>{
 ...
 return [id,{id,name,character,label,isDefault:index===0,type:'character_skin',
  ...
  portrait:new URL(`../skin image/${id}_crop.png`,import.meta.url).href}];
})));
