...
const guide={
  ...
  imp:{difficulty:3,stats:[1.5,3,5,1],trait:'숫자를 뒤틀어 중복과 유효 카드를 바꾸는 방해꾼',text:[
    '중복 판정 직전, <strong>나와 같은 숫자의 모든 비임프 플레이어</strong>에게서 카드 숫자 1씩을 빼앗습니다.',
    '대상 카드는 최소 0까지 내려가고, 임프는 <strong>실제로 빼앗은 만큼</strong> 숫자가 증가합니다.',
    '이후 변경된 숫자로 중복·피해·이벤트 효과를 판정합니다.'
  ]},
  ...
  demonsword:{difficulty:4.5,stats:[5,4,.5,5],trait:'포식 성장과 막타를 통한 장기 스노우볼',text:[
    ...
    '처치 턴에 기여하면 <strong>총 +4</strong>,<br>그중 공동 최고 피해라면 <strong>총 +8</strong>을 획득합니다.',
